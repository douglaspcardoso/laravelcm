            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Página
                        <small>Camisaria > Produtos</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> Página: Camisaria > Produtos
                        </li>
                    </ol>
                    <div class="col-md-12">
                        {!! Form::open(['class' => 'form-horizontal', 'route' => ['content.camisaria.produtos.update'],
                                                ...
                                                <div class="col-md-3">
                                                    <div class="thumbnail">
                                                        ...
                                                        <div class="caption text-center">
                                                            <a href="{{route('content.camisaria.produtos.destroy', $image->id)}}" class="btn btn-danger" role="button">Remover</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
