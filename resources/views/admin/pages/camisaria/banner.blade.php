            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> Página: Camisaria > Banner
                        </li>
                    </ol>
                    <div class="col-md-12">
                        {!! Form::open(['class' => 'form-horizontal', 'route' => ['content.camisaria.banner.update'], 'method' => 'put', 'files' => true]) !!}
                        <div class="panel panel-default">
                            <!-- Default panel contents -->
                            <div class="panel-heading"><h4>Banner Principal</h4></div>
